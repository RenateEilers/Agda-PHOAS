...
... | ∃ eh₁ , cC₁ rewrite cC₁ with x {fromNat v} {eval b₂} (Eq {!!}) 
... | nope with cC {{!!}} {h = update (fromNat v) (eval b₂) eh₁} {h₁ = eh₁} {s = s} nope
... | ∃ eh₂ , cC₂ = ∃ eh₂ , {!cC₂!} 


compilerCorrectness : ∀ {e : ClosedExpr} {n : Nat} {s : Stack n} {h : Stack (Succ (#vars e))} -> (fst (exec (compile e) (s , h))) ≡ eval e ▻ s
compilerCorrectness {e} {n} {s} {h} with cC {#vars e} {n} {h} {snd (exec (compile e) (s , h))} {s} {e} {e} (e≡e {Fin (Succ (#vars e))} {Nat} {_≂_} {e})
